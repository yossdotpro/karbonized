...
describe('tool helpers', () => {
	...
	it('allows only editing commands', () => {
		...
		expect(isAllowedCommand('view.toggle-agent')).toBe(false);
		// Layouts could close the agent's own panel.
		expect(isAllowedCommand('view.cycle-layout')).toBe(false);
		expect(isAllowedCommand('view.layout-canvas')).toBe(false);
