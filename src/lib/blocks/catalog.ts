	...
	},
	{
		...
		properties: [
			...
			},
			{
				...
				min: 0,
				max: 20,
				description: 'Width of the outline around the letters, in pixels.',
			},
			{
				key: 'outlineColor',
				kind: 'color',
				default: '#090b11',
				description: 'Color of the outline around the letters.',
			},
			{
				key: 'textShadowBlur',
				kind: 'number',
				...
				min: 0,
				max: 40,
				description: 'Blur of the shadow of the letters, in pixels.',
			},
			{
				key: 'textShadowX',
				kind: 'number',
				...
				min: -100,
				max: 100,
				description: 'Horizontal offset of the shadow of the letters.',
			},
			{
				key: 'textShadowY',
				kind: 'number',
				...
				min: -100,
				max: 100,
				description: 'Vertical offset of the shadow of the letters.',
			},
			{
				key: 'textShadowColor',
				kind: 'color',
				default: '#090b11',
				description: 'Color of the shadow of the letters.',
			},
		],
	},
	{
	...
	},
	{
		...
		properties: [
			...
			},
			{
				...
				description:
					'Whether the shape is filled with one color or a gradient.',
			},
			{
				key: 'gradientFrom',
				kind: 'color',
				default: '#0da2e7',
				description: 'First color of the gradient fill.',
			},
			{
				key: 'gradientTo',
				kind: 'color',
				default: '#5895c8',
				description: 'Second color of the gradient fill.',
			},
			{
				key: 'gradientAngle',
				kind: 'number',
				...
				min: 0,
				max: 360,
				description: 'Angle of the gradient fill, in degrees.',
			},
			{
				key: 'strokeColor',
				kind: 'color',
